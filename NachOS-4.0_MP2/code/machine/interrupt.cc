...
int
Interrupt::Write(char *buffer, int size, int fid)
{
	return kernel->Write(buffer, size, fid);
}
...
//----------------------------------------------------------------------
int
Interrupt::Read(char *buffer, int size, int fid)
{
	return kernel->Read(buffer, size, fid);
}
