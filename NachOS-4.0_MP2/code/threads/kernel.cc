...
{
	return fileSystem->OpenMe(name);
}

int Kernel::Write(char *buffer, int size, int fid)
{
	return fileSystem->Write(buffer, size, fid);
}

int Kernel::Read(char *buffer, int size, int fid)
{
	return fileSystem->Read(buffer, size, fid);
}

int Kernel::Close(int fid)
{
	return fileSystem->CloseMe(fid);
}
